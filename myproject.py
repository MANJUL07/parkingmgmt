...
#code to enter the vechile type
                typee=True
                while typee==True:
...
#code to enter the vechile name
                name=True
                while name==True:
...
#code to enter the owners name:
                ...
                while o==True:
                    ...
                    if OName=="":
                        ...
                        o=not True
#code to enter the date and time:
                d=True
                while d==True:
                ...
                while t==True:
                    ...
                    if t=="":
                        ...
                        t=not True
                print("\n............................................................Record")
#code to remove the entry from register:
            elif ch==2:
                no=True
                while no==True:
                    ...
                    if Vno=="":
                        ...
                        print("###### Enter Valid Vehicle Number #####")
#code to display the vechiles present in parking area
            elif ch==3:
                count=0
                print("----------------------------------------------------------------------------------------------------------------------")
                ...
                print("-------------------------------------------------------------------")
#code for spaces left in parking area:
            elif ch==4:
                print("----------------------------------------------------------------------------------------------------------------------")
...
#code for displaying the parking rate:
                ...
                print("---------------------------------------------------------------------")
#code for generate bills for different type of vechils parked:
            elif ch==6:
